...
while True:
    ...
    for face in get_face(img):
        try:
            ...
            cv2.putText(img,"Emotion: "+predict_emotion(cv2.cvtColor(cv2.resize(face[0], (48,48)), cv2.COLOR_BGR2GRAY).reshape(-1, 48,48, 1) , emotion_model), (x, y-60), font, font_size, font_color, font_thickness)
